import type { HookPayload, ModelDefaults, Plugin, RegisteredPlugin, StoreCore, StoreSchema } from '@rstore/shared'
...
>(store: StoreCore<TSchema, TModelDefaults>, plugin: RegisteredPlugin) {
  await plugin.setup({
