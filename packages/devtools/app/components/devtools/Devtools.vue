...
import DevtoolsCache from './Cache.vue'
import DevtoolsCollections from './Collections.vue'
import DevtoolsHistory from './History.vue'
import DevtoolsModules from './Modules.vue'
import DevtoolsPlugins from './Plugins.vue'
import DevtoolsSubscriptions from './Subscriptions.vue'
