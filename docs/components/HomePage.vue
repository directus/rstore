  ...
  <section class="homepage relative overflow-hidden py-4 !pb-32 sm:py-8">
    ...
    <div class="relative z-10 mx-auto flex w-full max-w-[1400px] flex-col gap-4 px-4 sm:gap-8">
      ...
      <section class="relative overflow-hidden rounded-[28px] border border-violet-600/[0.18] bg-white/[0.78] p-5 shadow-[0_26px_80px_rgba(5,24,11,0.08),inset_0_1px_0_rgba(255,255,255,0.7)] backdrop-blur-xl sm:p-7 dark:border-violet-400/20 dark:bg-[linear-gradient(145deg,rgba(23,18,28,0.98),rgba(13,9,18,0.96))] dark:shadow-[0_30px_90px_rgba(0,0,0,0.34),inset_0_1px_0_rgba(255,255,255,0.04)] flex max-md:flex-col gap-2 md:gap-12">
        ...
        <div class="relative z-10 mb-5 flex flex-col gap-2">
          <div class="reveal-up font-mono text-xs uppercase tracking-[0.18em] text-violet-600 dark:text-violet-300" style="animation-delay: 590ms;">
            TESTIMONIAL
          </div>
          <h2 class="reveal-up m-0 text-balance text-[clamp(1.85rem,3vw,2.6rem)] font-extrabold leading-[1.05] tracking-[-0.04em]" style="animation-delay: 660ms;">
        ...
        >
          ...
          <div class="relative z-10 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div class="max-w-[42rem]">
              ...
              <p class="mb-0 mt-4 font-mono text-xs uppercase tracking-[0.18em] text-violet-600 dark:text-violet-300">
                {{ testimonial.name }}
              </p>
            </div>
            ...
            <img
              ...
              class="h-24 w-24 shrink-0 rounded-full border border-violet-600/[0.2] object-cover shadow-[0_18px_40px_rgba(0,0,0,0.12)] dark:border-violet-400/25"
            >
          </div>
        </article>
      </section>
